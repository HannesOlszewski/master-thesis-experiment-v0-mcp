...
EXPERIMENT_API_URL=https://34.51.205.59:8000      # Base URL of the external API (MUST use HTTPS)
...
- The external API enforces HTTPS connections
- Update your environment variable to: `https://34.51.205.59:8000`
